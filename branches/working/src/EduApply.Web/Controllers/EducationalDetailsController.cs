...
namespace EduApply.Web.Controllers
{
    ...
    public class EducationalDetailsController : Controller
    {
        ...
        public ActionResult Update(long id, string editSchName, string editQualification, string editClassOfDegree, string editcgpa,string editGradMonth, int editEntryYear, int editGradYear)
        {
            ...
            educationalDetail.CGPA = editcgpa;
        ...
        [HttpPost]
        public ActionResult AddEducationalDetail(string schoolName, string qualification, string classOfDegree, string cgpa, string otherDegree, int entryYear,string graduationMonth, int graduationYear)
        {
            var applicationId = Convert.ToInt64(Session["AppId"]);
            var application = _registrationService.GetApplicationDetails(applicationId);
            ...
            var classOfDegres = _configurationService.GetDegrees(application.AppFormId);
            int c = classOfDegres.Count();
            //eduDetailsModel.ClassOfDegrees = classOfDegres;
            ...
            eduDetailsModel.MaxEntry = templateSettings.MaxEntry;
            eduDetailsModel.EducationalDetails = educationalDetails;
            eduDetailsModel.ClassOfDegrees = classOfDegres; //Session["FormCog"] as List<ClassOfDegree> ?? new List<ClassOfDegree>();
