                                    ...
                                    <div className="row">
                                        <div className="col-sm-6">
                                            ...
                                            <div className="js-form-message form-group">
                                                ...
                                                <input type="text" className="form-control" name="firstName" id="firstName" placeholder="Nataly" aria-label="Nataly" required data-msg="Please enter first your name" />
                                            </div>
                                        ...
                                        <div className="col-sm-6">
                                            ...
                                            <div className="js-form-message form-group">
                                                ...
                                                <input type="text" className="form-control" name="lastName" id="lastName" placeholder="Gaga" aria-label="Gaga" required data-msg="Please enter last your name" />
                                            </div>
                                        ...
                                        <div className="col-sm-12">
                                            ...
                                            <div className="js-form-message form-group">
                                                ...
                                                <input type="email" className="form-control" name="emailAddress" id="emailAddress" placeholder="nayagaga@pixeel.com" aria-label="alex@pixeel.com" required data-msg="Please enter a valid email address" />
                                            </div>
                                        ...
                                        <div className="col-sm-12">
                                            ...
                                            <div className="js-form-message form-group">
                                                ...
                                                <div className="input-group">
                                                    <textarea className="form-control" rows={4} name="message" id="message" placeholder="Hi there, I would like to ..." aria-label="Hi there, I would like to ..." required data-msg="Please enter a reason."></textarea>
                                                </div>
                                            </div>
