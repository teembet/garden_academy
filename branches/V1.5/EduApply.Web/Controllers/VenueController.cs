...
namespace EduApply.Web.Controllers
{
    ...
    public class VenueController : Controller
    {
        ...
        public VenueController(IConfigurationService configurationService, IAuditTrailRepository auditTrailRepository)
        {
        ...
        {
            var venues = _ConfigurationService.GetVenues().ToList();
        ...
        public ActionResult Create(Venues venue)
        {
            ...
            var auditTrail = new AuditTrail()
            {
                ...
                Details = "created Session \'" + venue.Name + "\'",
        ...
        {
            var venue = _ConfigurationService.GetVenue(venueId);
        ...
        public ActionResult Edit(Venues venue)
        {
            ...
            var examVenues = _ConfigurationService.GetExamVenues(venue.Id);
        ...
        {
            var venue = _ConfigurationService.GetVenue(id);
            venue.Active = true;
            _ConfigurationService.UpdateVenue(venue);
            ...
            if (venueUpload != null)
            {
                if (venueUpload.ContentLength > 0)
                {
                    ...
                    if (uploadedVenues.Count > 0)
                    {
                        ...
                        {
                            var savedVenue = _ConfigurationService.GetVenue(venue.Name).FirstOrDefault() ?? new Venues();
                            ...
                            if (isUpdate)
                            {
                                ...
                                _ConfigurationService.UpdateVenue(savedVenue);
                                uploaded = true;
                            }
                            else
                            {
