...
<main>
      <div className="hero-page-about">
                    <h1 style={{fontSize:"48px",color:"#3A434B"}}>Frequently Asked Questions</h1>


                    <div className="row mt-3" style={{ width: "100%" }}>
                        <div className="col-md-6 offset-md-3 ">
                            <Search search={"What do you want to learn"} button_text={"Search"} onSearchSubmit ></Search>
                        </div>
                    </div>
...
<div className="mx-auto col-lg-8">
  ...
  <Card style={{border:"none",height:"auto"}}>
    <Card.Header>
        <h3 className="text-primary">What is Garden Academy</h3>
  ...
  <Card style={{border:"none",height:"auto"}}>
    <Card.Header>
        <h3 className="text-primary">Are there hidden charges when hiring a talents</h3>
  ...
  <Card style={{border:"none",height:"auto"}}>
    <Card.Header>
        <h3 className="text-primary">What are the payment plans available</h3>
      <Accordion.Toggle as={Button} variant="link" eventKey="0">
       <FaChevronDown/>
      </Accordion.Toggle>
    </Card.Header>
  ...
  <Card style={{border:"none",height:"auto"}}>
    <Card.Header>
        <h3 className="text-primary">Why should i trust Garden Academy</h3>
