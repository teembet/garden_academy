            ...
            <div className="container space-bottom-2">
                ...
                <div className="row space-top-3 space-bottom-2">
                    <div className=" col-md-6">
                        ...
                        <div className="row" style={{ margin: "0 5px" }}>
                            ...
                            <p>
                                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eaque, quia voluptate. Assumenda facere labore atque molestiae minus repellat? Repudiandae totam fugiat obcaecati dolore. Distinctio, quibusdam aliquam! Voluptate ipsa error natus?
                            </p>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit nam aliquid tenetur possimus dolorem hic mollitia saepe, itaque dolores vero dignissimos culpa facere id, corrupti fuga sapiente. Ea, maiores totam?</p>
                    ...
                    <div className="col-md-6" style={{ padding: "5%", position: "relative" }}>

                        <img src={girl} alt="" className="img-fluid img-data d-none d-lg-block" />
                ...
                <div className="container space-bottom-2">
                    <div>
                        ...
                        <p style={{ textAlign: "center" }}>We have carefully chosen a team of experienced and hardworking people in different fields <br />to train the next set of tech professionals.</p>
                    </div>
                    <br /><br />
                    <div className="row">
                ...
                <div className="action-box">
                    <h2 className='text-primary' style={{ textAlign: "center" }}>Do you have what it takes to train the <br /> next set of tech superstars?</h2>

                    <button type="submit" className="btn btn-primary transition-3d-hover">Become a Facilitator</button>
                </div>
