...
namespace EduApply.Logic.Interfaces
{
    public interface IRegistrationService
    {
        ...
        void SaveFeeRequest(FeeRequestPayment feeRequest);
        FeeRequestPayment GetFeeRequest(string appNum);
        FeeRequestPayment GetFeeRequest(long payeeId, string paymentType);
        FeeRequestPayment GetFeeRequest(long payeeId);
        IEnumerable<FeeRequestPayment> GetFeeRequests();
        ...
        IEnumerable<ApplicantsProgramCourse> GetApplicantsProgramCourses(long applicationId);
        IEnumerable<ApplicantsProgramCourse> GetApplicantsProgramCourses();
        void SaveApplicantsProgramCourse(ApplicantsProgramCourse progCourse);
        void DeleteApplicantsProgramCourse(ApplicantsProgramCourse progCourse);
        int GetTotalJambScore(string regNum);
