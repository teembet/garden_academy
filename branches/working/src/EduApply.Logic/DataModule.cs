...
namespace EduApply.Logic
{
    public class DataModule : Module
    {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<EFContext>().As<IDbContext>().InstancePerDependency();
            ...
            builder.RegisterType<VenueAssignmentService>().As<IVenueAssignmentService>().InstancePerLifetimeScope();
