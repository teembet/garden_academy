...
namespace EduApply.Web.Controllers
{
    public class ReferenceController : Controller
    {
        ...
        public ReferenceController(IRegistrationService registrationService, IApplicationFormRepository appForm, IEventLogRepository eventLogRepo, IStateManager stateManager)
        {
        ...
        public ActionResult AddReference()
        {
            ...
            var isRightState = _stateManager.ConfirmFillStage(application, templatesInAppForm, "REF");
            if (!isRightState)
            {
